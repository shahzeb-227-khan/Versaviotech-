...
const blogStructuredData = {
  ...
  '@type': 'Blog',
  name: 'Versavio Tech Insights',
  description: 'Insights on AI, SAP BTP, automation, and enterprise technology for digital transformation.',
  publisher: {
    '@type': 'Organization',
    name: 'Versavio Tech'
  },
  blogPost: blogPosts.map(post => ({
    ...
    url: `https://www.versaviotech.com/blog/${post.slug}`
  }))
};
...
export const Blog: React.FC = () => {
  return (
    <>
      <SEOHead
        title="Insights — AI, SAP & Enterprise Technology"
        description="Read Versavio Tech's insights on AI, SAP BTP, automation, and enterprise technology to stay informed on digital transformation strategies."
        canonicalUrl="/blog"
